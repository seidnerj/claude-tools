...
**Never use real names or personal email addresses** in any project artifact (code, config, commits, docs). Use the GitHub handle `seidnerj` for all attribution, copyright notices, and author fields. The git user email should always be the GitHub noreply address, never a personal email.
